...
def create_access_token(data: dict):
    to_encode = data.copy()
    expire = datetime.utcnow() + timedelta(minutes=ACCESS_TOKEN_EXPIRE_MINUTES) #datetime.utcnow(datetime.timezone.utc) + timedelta(minutes=ACCESS_TOKEN_EXPIRE_MINUTES)
...
def verify_access_token(token: str, credentials_exception):
    try:
        ...
        # Convert id to string before creating TokenData
